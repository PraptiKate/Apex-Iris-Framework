...
# This function saves the data for your Cyan Website
def export_to_json(leaderboard_data):
    # Ensure we are pointing to the docs folder in the root
    json_path = os.path.join(os.getcwd(), 'docs', 'data.json')
...
# Example usage: 
# Call export_to_json(your_final_list_of_results) here
